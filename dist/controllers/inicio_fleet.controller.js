...
var encrypt = false; // interfaz 41 home fleet sin filtro
...
function post_interfaz41_fleet_home(request, response) {
  ...
  var query = "select * from interfaz41FleetHome3('" + id_usuario + "')"; // Se reemplaza las comillas doble por simples para la consulta
  ...
  _database.pool.query(query, function (error, results) {
    results.rows.forEach(function (element) {
      ...
      element.ganancia_semanal = (0, _DataValues.getCentavos)(element.ganancia_semanal);
      element.ganancia_actual = (0, _DataValues.getCentavos)(element.ganancia_actual);
      element.numero_viajes_actual = element.numero_viajes_actual.toString();
      element.rango_fechas = (0, _DataValues.getRangeDate)(element.rango_fechas);
    });
...
function post_interfaz42_fleet_home(request, response) {
  ...
  var query = "select * from interfaz41FleetHome3_Filtro('" + id_usuario + "','" + fecha_filtro + "')"; // Se reemplaza las comillas doble por simples para la consulta
  ...
  _database.pool.query(query, function (error, results) {
    results.rows.forEach(function (element) {
      ...
      element.ganancia_actual = (0, _DataValues.getCentavos)(element.ganancia_actual);
      element.numero_viajes_actual = element.numero_viajes_actual.toString();
      element.rango_fechas != null ? element.rango_fechas = (0, _DataValues.getRangeDate)(element.rango_fechas) : element.rango_fechas = 'Sin registro';
    });
...
function post_interfaz121_tiempo_real(request, response) {
  ...
  var query = "select * from sp_cinterfaz121_FleetTiempo_real('" + id_usuario + "')"; // Se reemplaza las comillas doble por simples para la consulta
  ...
  _database.pool.query(query, function (error, results) {
    results.rows.forEach(function (element) {
      ...
      element.out_efectivo = (0, _DataValues.getCentavos)(element.out_efectivo);
      element.out_tarjeta = (0, _DataValues.getCentavos)(element.out_tarjeta);
      element.out_comision = (0, _DataValues.getCentavos)(element.out_comision);
      element.out_ganancia_final = (0, _DataValues.getCentavos)(element.out_ganancia_final);
    });
...
function post_interfaz124_socio_conductor(request, response) {
  ...
  var query = "select * from sp_cinterfaz75_mibilletera('" + id_usuario + "')"; // Se reemplaza las comillas doble por simples para la consulta
...
function post_interfaz126_socio_no_conductor(request, response) {
  ...
  var query = "select * from interfaz126fleethome2('" + id_usuario + "')"; // Se reemplaza las comillas doble por simples para la consulta

  query = query.replace(/["]+/g, '');

  _database.pool.query(query, function (error, results) {
    results.rows.forEach(function (element) {
      element.ganancia_propietario = (0, _DataValues.getCentavos)(element.ganancia_propietario);
    });
